...
class TestIPDb(unittest.TestCase):
    ...
    def test_city(self):
        print("\n\ntest city start\n\n")
        city = ipdb_py.City("c:/work/ipdb/city.ipv4.ipdb")
    ...
    def test_district(self):
        print("\n\ntest district start\n\n")
        district = ipdb_py.District("c:/work/ipdb/china_district.ipdb")
    ...
    def test_station(self):
        ...
        base_station = ipdb_py.BaseStation("c:/work/ipdb/base_station.ipdb")
